...
render:
	...
	./build/render
	#ffmpeg -y -f rawvideo -pixel_format rgb24 -video_size 1718x706 -framerate 60 -i rgb.out -vf "vflip" video.mp4
	ffmpeg -y -f rawvideo -pixel_format rgb24 -video_size 800x800 -framerate 60 -i rgb.out -vf "vflip" video.mp4
